...
public class LookUpJoinTest {
    ...
    public static void main(String[] args) {
        ...
        tableEnv.executeSql("" +
                ...
                ") WITH ( " +
                "  'connector' = 'jdbc', " +
                "  'url' = 'jdbc:mysql://192.168.20.62:3306/gmall', " +
                "  'username' = 'root', " +
                "  'password' = '123456', " +
                "  'lookup.cache.max-rows' = '10', " +               //存最大10条数据  存一个小时
        ...
        //关联并打印
        tableEnv.sqlQuery("select t1.id, t1.vc,t2.dic_name from t1 join my_base_dic FOR SYSTEM_TIME AS OF t1.pt as t2 on t1.id = t2.dic_code")
                .execute()
                .print();
