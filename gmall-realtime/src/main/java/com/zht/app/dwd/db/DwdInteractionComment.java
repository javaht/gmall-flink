...
public class DwdInteractionComment {
    public static void main(String[] args) {
        ...
        tableEnv.executeSql("create table topic_db(" +
                ...
                "`ts` string      " +
                ")" + KafkaUtils.getKafkaDDL("topic_db", "dwd_interaction_comment"));
        ...
        Table resultTable = tableEnv.sqlQuery("select      " +
                ...
                "dic.dic_name,      " +
                "ts      " +
                "from comment_info ci  left join " +
                " base_dic for system_time as of ci.proc_time as dic  on ci.appraise = dic.dic_code");
        ...
        tableEnv.executeSql("create table dwd_interaction_comment(      " +
                ...
                ")" + KafkaUtils.getUpsertKafkaDDL("dwd_interaction_comment"));
