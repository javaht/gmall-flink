...
//        System.setProperty("HADOOP_USER_NAME", "atguigu");
        ...
        tableEnv.executeSql("" +
                ...
                ")" + KafkaUtils.getKafkaDDL("dwd_trade_order_detail", "dwd_trade_pay_detail_suc"));
        ...
        tableEnv.executeSql("create table topic_db(" +
                ...
                "`ts` string  " +
                ")" + KafkaUtils.getKafkaDDL("topic_db", "dwd_trade_pay_detail_suc"));
...
//                "and data['payment_status']='1602'"
        ...
        Table resultTable = tableEnv.sqlQuery("" +
                ...
                "left join `base_dic` for system_time as of pi.proc_time as dic  on pi.payment_type = dic.dic_code");
